...
Archivo: "PantallaPomodoro.vue"
Descripcion: Representa la sesión de enfoque de la técnica Pomodoro.
-->
  ...
  <section class="timer-frame">
    ...
    <section class="timer-content">
      ...
      <div class="timer-card">
        ...
        <div class="timer-circle pomodoro-theme" :style="{ '--progress': progressDegrees }">
          <span class="technique-symbol">🍅</span>
          <strong>{{ timeLabel }}</strong>
          <small>Tiempo restante</small>
        </div>

        <p class="cycle-copy">Pomodoro {{ cycleLabel }}</p>
