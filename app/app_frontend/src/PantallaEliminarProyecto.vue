...
Archivo: "PantallaEliminarProyecto.vue"
Descripcion: Representa la confirmación de eliminación de proyectos.
-->
  ...
  <section class="delete-frame">
    ...
    <section class="delete-content">
      ...
      <div class="muted-table" aria-hidden="true">
        <div v-for="projectItem in props.projects.slice(0, 6)" :key="projectItem.id" class="muted-row">
      ...
      <section class="delete-modal" role="dialog" aria-modal="true" aria-labelledby="deleteProjectTitle">
          <h2 id="deleteProjectTitle">Eliminar proyecto</h2>
        <p v-if="props.project">
          Estás seguro que quieres eliminar<br />
          el proyecto <strong>“{{ props.project.name }}”</strong>?
        </p>
        <p v-else>No se ha encontrado el proyecto seleccionado.</p>
        ...
        <div class="modal-actions">
          ...
          <button class="delete-button" type="button" :disabled="props.loading || !props.project" @click="emit('confirm')">
